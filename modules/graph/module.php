 ...
 * Module: graph
 *
 * Was the standalone plugin `os-graph`. Merged into the OS plugin; the
...
final class OS_Graph {
	...
	const REST_NS   = 'knowledge-graph/v1';
	const CATEGORY  = 'os-graph';
	const TYPES     = array (
  'node' => 
  array (
    'post_type' => 'os_knowledge_node',
    'singular' => 'Node',
    'plural' => 'Nodes',
	...
	public static function register_ability_category(): void {
		wp_register_ability_category(
			...
			array(
				'label'       => 'OS Graph',
				'description' => 'Abilities owned by OS Graph.',
			)
		);
	}
